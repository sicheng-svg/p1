...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contacts::Address, _impl_.home_),
  PROTOBUF_FIELD_OFFSET(::contacts::Address, _impl_.work_),
  ~0u,  // no _has_bits_
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contacts.Address.home"));
        } else
          goto handle_unusual;
        continue;
      // string work = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contacts.Address.work"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Address::_InternalSerialize(
  ...
  if (!this->_internal_work().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "contacts.Address.work");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_work(), target);
  }
...
People::_Internal::date(const People* msg) {
  return *msg->_impl_.date_;
}
void People::clear_date() {
...
void People::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_date()) {
    _this->_internal_mutable_date()->::PROTOBUF_NAMESPACE_ID::Any::MergeFrom(
        from._internal_date());
  }
